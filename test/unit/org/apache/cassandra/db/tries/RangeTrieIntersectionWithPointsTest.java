...
//                             array(of(27), of(27)));
    ...
    private RangeTrie<TestRangeMarker> mergeGeneratedRanges()
    {
    ...
    {
        final List<TestRangeMarker> testRanges = getTestRanges();
    ...
    public void testIntersection(String message, RangeTrie<TestRangeMarker> trie, List<TestRangeMarker> intersected, ByteComparable[]... sets)
    {
    ...
    List<TestRangeMarker> intersect(List<TestRangeMarker> markers, ByteComparable... ranges)
    {
        int rangeIndex = 0;
        int active = -1;
        ...
        for (TestRangeMarker marker : markers)
        {
            while (true)
            {
                ...
                if (nextRange == null)
                    ...
                    cmp = ByteComparable.compare(marker.position, nextRange, TrieUtil.VERSION);
