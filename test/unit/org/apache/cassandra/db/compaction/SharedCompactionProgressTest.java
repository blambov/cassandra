...
public class SharedCompactionProgressTest
{
    ...
    private CompactionProgress getMockProgress()
    {
        ...
        final Collection<SSTableReader> input = mockSSTable("i");
        when(mockProgress.inSSTables()).thenReturn(input);
        final Collection<SSTableReader> output = mockSSTable("o");
    ...
    private Collection<SSTableReader> mockSSTable(String nameprefix)
    {
        ...
        return ImmutableList.of(readerMock);
    }
