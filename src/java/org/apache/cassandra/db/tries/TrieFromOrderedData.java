...
/**
 * A trie constructed on the fly from ordered data, from anything
 * that can produce a sorted iterator of its data.
 * Because cursors necessarily list prefixes before their children,
 * If the result is to be used in reverse direction the input must
 * be prefix-free.
 */
