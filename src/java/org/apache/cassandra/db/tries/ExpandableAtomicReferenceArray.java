 ...
 * <p>
 * (For example, derivative InMemoryReadTrie objects need to have up-to-date references to the content and metadata
 * arrays of the source InMemoryTrie, because modification of the trie can cause the arrays to expand leaving them
