...
//extends InMemoryBaseTrie<U> implements DeletionAwareTrie<T, D>
//{
...
//    {
//        org.apache.cassandra.db.tries.DeletionAwareCursor.Cursor<V, E> mutationCursor = org.apache.cassandra.db.tries.DeletionAwareCursor.impl(mutation).cursor(Direction.FORWARD);
...
//               org.apache.cassandra.db.tries.DeletionAwareCursor.Cursor<V, E> mutationCursor,
//               final UpsertTransformer<T, V> dataTransformer,
//               final UpsertTransformer<D, E> deletionTransformer,
//               final UpsertTransformer<T, E> deleter)
//    throws TrieSpaceExhaustedException
